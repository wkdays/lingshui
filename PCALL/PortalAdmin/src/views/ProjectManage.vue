<template>
  <div class="page-card">
    <div class="page-header">
      <span class="page-title">项目进度管理</span>
    ...
    <el-dialog v-model="dialogVisible" :title="isEdit ? '编辑项目' : '新增项目'" width="900px" destroy-on-close>
      <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="摘要" prop="summary">
          <el-input v-model="form.summary" type="textarea" :rows="3" placeholder="请输入项目摘要" />
        </el-form-item>
...
import { projectApi, uploadFile } from '../api'
...
const toolbarConfig = {}
const editorConfig = { placeholder: '请输入详细描述...' }
...
const loadList = async () => {
  loading.value = true
  try {
    const res = await projectApi.list({ page: page.value, limit: limit.value })
    list.value = res.data
...
const handleAdd = () => {
  isEdit.value = false
  editId.value = null
  Object.assign(form, { title: '', cover: '', summary: '', content: '', progress: 0 })
